...
export const CARD_DISPLAY = {
  ...
  THUMBNAIL_WIDTH: 120 / CARD_ASPECT_RATIO,
  PREVIEW_HEIGHT: 250,
  PREVIEW_WIDTH: 250 / CARD_ASPECT_RATIO,
  COMPARISON_WIDTH: Math.min(SCREEN_DIMENSIONS.WIDTH * 0.42, 160),
  COMPARISON_HEIGHT: Math.min(SCREEN_DIMENSIONS.WIDTH * 0.42, 160) / CARD_ASPECT_RATIO,
};
